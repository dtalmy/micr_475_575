...
ggplot(lga_flights_16, aes(x = distance, y = air_time)) +
  ...
  labs(title = "Air Time vs Distance (LGA, 16th of Month)",
       x = "Distance (miles)",
       y = "Air Time (minutes)")
...
Your answer here: There is a linear relationship with air time increasing as distance increases.
...
Your answer here: To prevent NA values you have to filter them out before plotting. This removes rows with missing values so ggplot doesn't automatically drop them.
...
ggplot(flights_speed, aes(x = speed)) +
...
Your answer here: There is a bell shape, with most flights around 400 mph.
